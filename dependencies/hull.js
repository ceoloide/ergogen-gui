...
function _ccw(p1, p2, p3, clockwise) {
    ...
    // For clockwise (default): return true if clockwise or collinear (crossProduct <= 0)
    // For anti-clockwise: return true if counter-clockwise or collinear (crossProduct >= 0)
