        ...
        <div style={{
            ...
            <div style={{ pointerEvents: 'auto' }}>
                {Object.entries(points).map(([name, point]) => {
                    ...
                    const tags = meta.tags || point.tags || {};
                    ...
                    // Check if it's a key
                    // Check if any tag matches "key" or starts with "key_" (case insensitive?)
                    // Ergogen tags are usually lowercase.
                    const hasKeyTag = tagList.some(t => t === 'key' || t.startsWith('key_'));
