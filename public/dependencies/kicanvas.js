...
l(n3, "initiate_download");
var pt = class s {
    static{l(this, "FileSystemBase")
    ...
    *list() {
    ...
    static is_kicad_file(e) {
        return ["kicad_pcb", "kicad_pro", "kicad_sch"].includes(Rt(e))
    }
    async walk(e) {
  ...
  , o3 = class {
    static{l(this, "MergedFileSystem")
    }constructor(e) {
  ...
  , a3 = class s extends pt {
    constructor(t) {
        super(s.into_entries(t));
        this.file_list = t
    }
    static{l(this, "LocalFileSystemBase")
    }async load_file(t) {
  ...
  , l3 = class s extends a3 {
    static{l(this, "DragAndDropFileSystem")
    }static async fromDataTransfer(e) {
        let t = [];
        for (let c = 0; c < e.items.length; c++) {
            let p = e.items[c]?.webkitGetAsEntry();
            p && t.push(p)
        }
        let r = await s.walk(t)
          , i = new Map;
        for (let c of r)
            if (c.isFile && s.is_kicad_file(c.name)) {
                let p = await s.load(c);
                i.set(Be(c.fullPath), p)
            }
        let n = s.lcp(Array.from(i.keys()))
          , o = new Map([...i].map( ([c,p]) => [t2(n, c), p]));
        return new s(o)
    }
    static lcp(e) {
        let t = e[0] ?? "";
...
var c3 = class {
    static{l(this, "DropTarget")
        ...
        e.addEventListener("drop", async r => {
            ...
            if (!i)
                return;
            let n = await l3.fromDataTransfer(i);
            t(n)
        }
        , !1)
    }
...
var p3 = class s extends Event {
    ...
    static{l(this, "ContextRequestEvent")
...
l(Qn, "requestLazyContext");
async function Yn(s, e, t) {
    Es(s, e, t)
}
l(Yn, "provideLazyContext");
function Js(s) {
    return class extends s {
        static{l(this, "WithContext")
        }constructor(...t) {
            super(...t)
        }
...
l(u3, "as_array");
function Cs(s) {
    return i2(s) ? s : r2(s) ? Array.from(s) : [s]
}
l(Cs, "iterable_as_array");
...
function Gn(s, e) {
    ...
    for (let i = 0; i < s.length - 1; i++)
        t.push(s[i]),
        e[i]instanceof Mr ? t.push(e[i].text) : t.push(`$$:${i}:$$`);
    return t.push(s[s.length - 1]),
    t.join("")
}
l(Gn, "prepare_template_html");
function En(s, e) {
...
l(En, "apply_values_to_tree");
function Jn(s, e, t) {
    if (!s)
        return;
    let r = e.data.split(gr);
    if (!(!r || r.length == 1)) {
...
l(Jn, "apply_content_value");
function kn(s, e, t) {
    let r = e.value.split(gr);
    if (!(!r || r.length == 1)) {
        ...
        if (r.length == 3 && r[0] == "" && r[2] == "") {
            ...
            i === !0 ? e.value = "" : i === !1 || i === null || i === void 0 ? s.removeAttribute(e.name) : e.value = Nr(i, e.name);
            return
        }
        e.value = e.value.replaceAll(gr, (i, n) => {
            let o = t[parseInt(n, 10)];
            return Nr(o, e.localName)
        }
        )
    }
}
l(kn, "apply_attribute_value");
function *Ds(s) {
    if (!(s == null || s == null)) {
        if (fr(s)) {
...
l(Ds, "convert_value_for_content");
function Nr(s, e) {
    if (s == null || s == null)
        return "";
    if (fr(s))
        return s.toString();
    if (r2(s))
        return Array.from(s).map(t => Nr(t, e)).join("");
    throw new Error(`Invalid value ${s}`)
}
l(Nr, "convert_value_for_attr");
var we = class extends HTMLElement {
    ...
    #e() {
        ...
        t.styles && As(this.shadowRoot ?? document, u3(t.styles)),
        (async () => {
            let r = this.render();
...
`
  , N = class extends Js(we) {
    static{l(this, "KCUIElement")
    }static{this.styles = [In]
    }
}
;
var s2 = class s extends N {
    static{l(this, "KCUIIconElement")
...
;
window.customElements.define("kc-ui-icon", s2);
var he = class extends N {
    static{l(this, "KCUIButtonElement")
...
var mt = class extends N {
    static{l(this, "KCUIActivitySideBarElement")
    }static{this.styles = [...N.styles, y`
            :host {
                flex-shrink: 0;
                display: flex;
...
var Vr = class extends we {
    static{l(this, "KCUIAppElement")
    }static{this.useShadowRoot = !1
    }
}
;
window.customElements.define("kc-ui-app", Vr);
var Pr = class extends N {
    static{l(this, "KCUIControlListElement")
    }static{this.styles = [...N.styles, y`
            :host {
                display: flex;
                flex-direction: column;
...
;
window.customElements.define("kc-ui-control-list", Pr);
var Wr = class extends N {
    static{l(this, "KCUIControlListItemElement")
    }static{this.styles = [...N.styles, y`
            :host {
                margin-top: 0.2em;
                display: flex;
...
;
window.customElements.define("kc-ui-control-list-item", Wr);
function _t(s, e, t) {
    let r = t.value
      , i = !1;
    t.value = function(...n) {
...
l(_t, "no_self_recursion");
var h3 = class extends N {
    static{l(this, "KCUIMenuElement")
    }static{this.styles = [...N.styles, y`
            :host {
                width 100%;
                display: flex;
    ...
    set selected(e) {
        ...
        this.deselect(),
        !(!t || !(t instanceof ve)) && (t.selected = !0,
...
;
P([_t], h3.prototype, "send_selected_event", 1);
window.customElements.define("kc-ui-menu", h3);
var ve = class extends N {
    static{l(this, "KCUIMenuItemElement")
    }static{this.styles = [...N.styles, y`
            :host {
                display: flex;
                align-items: center;
...
window.customElements.define("kc-ui-menu-item", ve);
var Zr = class extends N {
    static{l(this, "KCUIMenuLabelElement")
    }static{this.styles = [...N.styles, y`
            :host {
                width: 100%;
                display: flex;
...
;
window.customElements.define("kc-ui-menu-label", Zr);
var n2 = class extends N {
    static{l(this, "KCUIDropdownElement")
    }static{this.styles = [...N.styles, y`
            :host {
                border-radius: 5px;
                border: 1px solid transparent;
...
P([L({
    type: Boolean
})], n2.prototype, "visible", 2),
P([L({
    type: Number
})], n2.prototype, "mouseout_padding", 2);
window.customElements.define("kc-ui-dropdown", n2);
var Sr = class extends N {
    static{l(this, "KCUIFilteredListElement")
    }static{this.styles = [...N.styles, y`
            :host {
                display: contents;
            }
...
var Tr = class extends N {
    static{l(this, "KCUIFloatingToolbarElement")
    }static{this.styles = [...N.styles, y`
            :host {
                z-index: 10;
                user-select: none;
...
;
window.customElements.define("kc-ui-floating-toolbar", Tr);
var yr = class extends N {
    static{l(this, "KCUIFocusOverlay")
    }static{this.styles = [...N.styles, y`
            :host {
                z-index: 10;
                user-select: none;
...
;
window.customElements.define("kc-ui-focus-overlay", yr);
var Lr = class extends N {
    static{l(this, "KCUIPanelElement")
    }static{this.styles = [...N.styles, y`
            :host {
                width: 100%;
                height: 100%;
...
;
window.customElements.define("kc-ui-panel", Lr);
var Xr = class extends N {
    static{l(this, "KCUIPanelTitleElement")
    }static{this.styles = [...N.styles, y`
            :host {
                flex: 0;
                width: 100%;
...
;
window.customElements.define("kc-ui-panel-title", Xr);
var Or = class extends N {
    static{l(this, "KCUIPanelBodyElement")
    }static{this.styles = [...N.styles, y`
            :host {
                width: 100%;
                min-height: 0;
...
;
window.customElements.define("kc-ui-panel-body", Or);
var Ur = class extends N {
    static{l(this, "KCUIPanelLabelElement")
    }static{this.styles = [...N.styles, y`
            :host {
                width: 100%;
                display: flex;
...
;
window.customElements.define("kc-ui-panel-label", Ur);
var Fr = class extends N {
    static{l(this, "KCUIPropertyList")
    }static{this.styles = [...N.styles, y`
            :host {
                display: grid;
                gap: 1px;
...
;
window.customElements.define("kc-ui-property-list", Fr);
var d3 = class extends N {
    static{l(this, "KCUIPropertyListItemElement")
    }static{this.styles = [...N.styles, y`
            :host {
                display: contents;
            }
...
window.customElements.define("kc-ui-property-list-item", d3);
var Ze = class extends N {
    static{l(this, "KCUIRangeElement")
    }static{this.styles = [...N.styles, y`
            :host {
                display: block;
                width: 100%;
...
P([v("input", !0)], Ze.prototype, "input", 2);
window.customElements.define("kc-ui-range", Ze);
var xr = class extends N {
    static{l(this, "KCUIResizerElement")
    }static{this.styles = [...N.styles, y`
            :host {
                z-index: 999;
                user-select: none;
        ...
        this.addEventListener("mousedown", r => {
            ...
            , "mouse_move")
              , c = this.addDisposable(I(window, "mousemove", o))
              , p = l(h => {
...
;
window.customElements.define("kc-ui-resizer", xr);
var $s = y`
    :host(.grow) {
        flex-basis: unset;
        flex-grow: 999;
...
;
window.customElements.define("kc-ui-view", wr);
var vr = class extends N {
    static{l(this, "KCUISplitView")
    }static{this.styles = [...N.styles, $s, y`
            :host {
                display: flex;
                height: 100%;
...
;
window.customElements.define("kc-ui-split-view", vr);
var o2 = class extends N {
    static{l(this, "KCUITextFilterInputElement")
    }static{this.styles = [...N.styles, y`
            :host {
                display: flex;
                align-items: center;
...
;
P([v("input", !0)], o2.prototype, "input", 2),
P([v("button", !0)], o2.prototype, "button", 2);
window.customElements.define("kc-ui-text-filter-input", o2);
var a2 = class extends N {
    static{l(this, "KCUIToggleMenuElement")
    }static{this.styles = [...N.styles, y`
            * {
                box-sizing: border-box;
            }
...
P([L({
    type: Boolean
})], a2.prototype, "visible", 2);
window.customElements.define("kc-ui-toggle-menu", a2);
    ...
    *transform_all(e) {
    ...
    inverse() {
        let e = this.elements[0]
          ...
          , b = p * i - n * c
          , g = 1 / (e * m + t * _ + r * b);
        return new s([m * g, (-h * t + r * p) * g, (o * t - r * n) * g, _ * g, (h * e - r * c) * g, (-o * e + r * i) * g, b * g, (-p * e + t * c) * g, (n * e - t * i) * g])
    }
...
var O = class s {
    ...
    intersect_segment(e, t) {
        ...
        for (let h of [r, i, n, o]) {
            ...
            m && m.sub(c).squared_magnitude < p.sub(c).squared_magnitude && p.set(m)
        }
        return c.equals(p) ? null : p
    }
}
;
var q = class s {
    ...
    static{l(this, "Arc")
        ...
        o.x /= 1e6,
        o.y /= 1e6;
        let c = o.sub(t).magnitude, p = e.sub(o).angle, h = t.sub(o).angle, m = r.sub(o).angle, _, b = h.sub(p).normalize(), M = m.sub(p).normalize();
...
function Dn(s, e, t) {
    ...
    let M = h * m * (s.y - t.y)
      ...
      , lt = M + Z - w
      , Fe = Math.sqrt(g * g + T * T + C * C)
      , $ = (M + Z - w) / X
      , se = $ * Math.sqrt(Fe / lt * Fe / lt + F / X * F / X)
      , br = (s.x + e.x) / 2 - $
      , Us = Math.sqrt(1 / 8 + se * se)
      , Fs = br / h
      , xs = Fs * Math.sqrt(Us / br * Us / br + _ / h * _ / h)
      , e2 = Fs + (s.y + e.y) / 2
      , ws = Math.sqrt(xs * xs + 1 / 8)
      , vs = Math.floor(($ + 50) / 100) * 100
      , Qs = Math.floor((e2 + 50) / 100) * 100
      , Ys = Math.floor(($ + 5) / 10) * 10
      , Ks = Math.floor((e2 + 5) / 10) * 10;
    return Math.abs(vs - $) < se && Math.abs(Qs - e2) < ws ? (i.x = vs,
    i.y = Qs) : Math.abs(Ys - $) < se && Math.abs(Ks - e2) < ws ? (i.x = Ys,
    i.y = Ks) : (i.x = $,
    i.y = e2),
    i
}
l(Dn, "arc_center_from_three_points");
var m3 = class {
    ...
    get matrix() {
        let e = this.viewport_size.x / 2
          ...
          , o = -(this.center.y - t) + i
          , c = this.flipped ? -1 : 1;
        return U.identity().scale_self(c, 1).translate_self(n, o).rotate_self(this.rotation).scale_self(this.zoom, this.zoom)
    }
    get bbox() {
...
Context: ${p2(s, o)}`)
            ...
            if (b3(c) || ["a", "b", "c", "d", "e", "f", "_"].includes(c.toLowerCase()))
                continue;
            if (c === ")" || _3(c)) {
  ...
  , a = {
    ...
    list(s, e=R.any) {
        return {
            ...
            name: s,
            accepts: [s],
            fn: l( (t, r, i) => i.slice(1).map(n => e(t, r, n)), "fn")
        }
    },
...
function V(s, ...e) {
    E(s) && (u2.info(`Parsing expression with ${s.length} chars`),
    s = nn(s),
    ...
    for (let o of e)
        if (o.kind == 0)
            ...
            for (let c of o.accepts)
                t.set(c, o);
    if (r) {
        let o = u3(r.name)
          , c = s.at(0);
        if (!o.includes(c))
            throw new Error(`Expression must start with ${r.name}, but found ${c} in ${s}`);
        s = s.slice(1)
    }
    let n = {};
    i = 0;
    for (let o of s) {
        ...
        !c && (E(o) || le(o))) {
            if (c = t.get(i),
            !c) {
                u2.warn(`Bare element ${o} is undefined at position ${i} in expression ${s}`);
                continue
            }
            i++
        }
        if (!c && Array.isArray(o) && (c = t.get(o[0])),
        !c) {
            u2.warn(`No definition found for element ${o} in expression ${s}`);
            continue
        }
        let p = c.fn(n, c.name, o);
        n[c.name] = p
    }
    return n
}
...
function Ke(s, e) {
    ...
    do
        t = i.length,
        r -= 1,
        s = s.replaceAll(/(\$\{(.+?)\})/g, (n, o, c) => {
            if (i.includes(c))
                return u2.warn(`Cycle reference "${c}" in text "${s}"`),
                o;
            let p = e.resolve_text_var(c);
            return p === void 0 ? o : (i.push(c),
            p)
        }
        );
...
var K = class s {
  ...
  , G = class s {
    constructor(e) {
        ...
        this.justify = new M3;
        this.hide = !1;
        e && Object.assign(this, V(e, a.start("effects"), a.item("font", f3), a.item("justify", M3), a.atom("hide"), a.color()))
    }
    static{l(this, "Effects")
    }copy() {
        let e = new s;
...
var de = class {
    constructor(e, t) {
        ...
        this.embedded_files = [];
        Object.assign(this, V(t, a.start("kicad_pcb"), a.pair("version", R.number), a.pair("generator", R.string), a.pair("generator_version", R.string), a.object("general", {}, a.pair("thickness", R.number), a.pair("legacy_teardrops", R.boolean)), a.item("paper", bt), a.item("title_block", Qe), a.list("layers", R.item(Jr)), a.item("setup", kr), a.mapped_collection("properties", "property", r => r.name, R.item(Hr, this)), a.collection("nets", "net", R.item(h2)), a.collection("footprints", "footprint", R.item(me, this)), a.collection("zones", "zone", R.item(Mt, this)), a.collection("segments", "segment", R.item(d2, this)), a.collection("segments", "arc", R.item(m2, this)), a.collection("vias", "via", R.item(_2, this)), a.collection("drawings", "dimension", R.item(b2, this)), a.collection("drawings", "gr_line", R.item(Nt, this)), a.collection("drawings", "gr_circle", R.item(Vt, this)), a.collection("drawings", "gr_arc", R.item(Pt, this)), a.collection("drawings", "gr_poly", R.item(Wt, this)), a.collection("drawings", "gr_rect", R.item(Zt, this)), a.collection("drawings", "gr_text", R.item(Tt, this)), a.collection("groups", "group", R.item(ri)), a.pair("embedded_fonts", R.boolean), a.list("embedded_files", R.item(Ye)))),
        this.nets.sort( (r, i) => r.number - i.number)
    }
    static{l(this, "KicadPCB")
    }*items() {
        yield*this.drawings,
        yield*this.vias,
        yield*this.segments,
    ...
    get edge_cuts_bbox() {
        ...
        for (let t of this.drawings)
            t.layer != "Edge.Cuts" || !(t instanceof He) || (e = O.combine([e, t.bbox]));
        return e
    }
    find_footprint(e) {
  ...
  , Mt = class {
    constructor(e, t) {
        this.parent = t;
        this.locked = !1;
        Object.assign(this, V(e, a.start("zone"), a.atom("locked"), a.pair("net", R.number), a.pair("net_name", R.string), a.pair("net_name", R.string), a.pair("name", R.string), a.pair("layer", R.string), a.list("layers", R.string), a.object("hatch", {}, a.positional("style", R.string), a.positional("pitch", R.number)), a.pair("priority", R.number), a.object("connect_pads", {}, a.positional("type", R.string), a.pair("clearance", R.number)), a.pair("min_thickness", R.number), a.pair("filled_areas_thickness", R.boolean), a.item("keepout", Gr), a.item("fill", Er), a.collection("polygons", "polygon", R.item(Se)), a.collection("filled_polygons", "filled_polygon", R.item($r)), a.pair("tstamp", R.string), a.pair("uuid", R.string)))
    }
    static{l(this, "Zone")
    }get unique_id() {
        return this.uuid ?? this.tstamp
  ...
  , Ar = class {
    constructor(e) {
        ...
        this.edge_plating = !1;
        Object.assign(this, V(e, a.start("stackup"), a.pair("copper_finish", R.string), a.pair("dielectric_constraints", R.boolean), a.pair("edge_connector", R.string), a.pair("castellated_pads", R.boolean), a.pair("edge_plating", R.boolean), a.collection("layers", "layer", R.item(Cr))))
    }
    static{l(this, "Stackup")
    }
}
  , Cr = class {
    static{l(this, "StackupLayer")
    }constructor(e) {
  ...
  , b2 = class {
    constructor(e, t) {
        this.parent = t;
        this.locked = !1;
        Object.assign(this, V(e, a.start("dimension"), a.atom("locked"), a.pair("type", R.string), a.pair("layer", R.string), a.pair("tstamp", R.string), a.pair("uuid", R.string), a.list("pts", R.vec2), a.pair("height", R.number), a.pair("orientation", R.number), a.pair("leader_length", R.number), a.item("gr_text", Tt, this), a.item("format", Dr), a.item("style", Br)))
    }
    static{l(this, "Dimension")
    }resolve_text_var(e) {
...
var Br = class {
    ...
    *items() {
    ...
    get bbox() {
        if (!this.#t) {
            ...
            for (let r of this.drawings)
                r instanceof je || r instanceof gt || (e = O.combine([e, r.bbox.transform(t)]));
            e.context = this,
            this.#t = e
        }
        return this.#t
  ...
  , gt = class {
    ...
    static{l(this, "SymbolProperty")
    }get shown_text() {
        return Ke(this.value, this.parent)
    }
    get unique_id() {
        return this.uuid
    }
  ...
  , Nt = class extends g3 {
    static{l(this, "GrLine")
    }static{this.expr_start = "gr_line"
    }
}
  , f2 = class extends g3 {
    static{l(this, "FpLine")
  ...
  , Vt = class extends N3 {
    static{l(this, "GrCircle")
    }static{this.expr_start = "gr_circle"
    }
}
  , M2 = class extends N3 {
    static{l(this, "FpCircle")
    ...
    constructor(t, r) {
        ...
        if (n.angle !== void 0) {
            let o = W.from_degrees(n.angle).normalize720()
              , c = n.start
              , p = n.end
              , h = o.negative().rotate_point(p, c);
            o.degrees < 0 && ([p,h] = [h, p]),
            this.#e = q.from_center_start_end(c, p, h, n.width),
  ...
  , Se = class extends He {
    constructor(t, r) {
        ...
        this.parent = r;
        let i = this.constructor;
        Object.assign(this, V(t, a.start(i.expr_start), a.atom("locked"), a.pair("layer", R.string), a.atom("island"), a.list("pts", R.choice(["xy", R.vec2], ["arc", R.item(jr)])), a.pair("width", R.number), a.pair("fill", R.string), a.pair("uuid", R.string), a.pair("tstamp", R.string), a.item("stroke", D))),
        this.width ??= this.stroke?.width || 0,
  ...
  , $r = class extends Se {
    static{l(this, "FilledPolygon")
    }static{this.expr_start = "filled_polygon"
    }
}
  , Wt = class extends Se {
    static{l(this, "GrPoly")
    }static{this.expr_start = "gr_poly"
    }
}
  , N2 = class extends Se {
    static{l(this, "FpPoly")
  ...
  , Zt = class extends P3 {
    static{l(this, "GrRect")
    }static{this.expr_start = "gr_rect"
    }
}
  , V2 = class extends P3 {
    static{l(this, "FpRect")
    }static{this.expr_start = "fp_rect"
    }
}
  , zr = class {
    static{l(this, "TextRenderCache")
    }constructor(e) {
        Object.assign(this, V(e, a.start("render_cache"), a.positional("text", R.string), a.positional("angle", R.number), a.collection("polygons", "polygon", R.item(Se))));
  ...
  , St = class {
    ...
    static{l(this, "Text")
    }static{this.common_expr_defs = [a.item("at", K), a.atom("hide"), a.atom("unlocked"), a.object("layer", {}, a.positional("name", R.string), a.atom("knockout")), a.pair("tstamp", R.string), a.pair("uuid", R.string), a.item("effects", G), a.item("render_cache", zr)]
    }get shown_text() {
        return Ke(this.text, this.parent)
    }
    get unique_id() {
        return this.uuid ?? this.tstamp
    }
  ...
  , P2 = class {
    constructor(e, t) {
        ...
        this.locked = !1;
        this.remove_unused_layers = !1;
        let r = V(e, a.start("pad"), a.positional("number", R.string), a.positional("type", R.string), a.positional("shape", R.string), a.item("at", K), a.atom("locked"), a.vec2("size"), a.vec2("rect_delta"), a.list("layers", R.string), a.pair("roundrect_rratio", R.number), a.pair("chamfer_ratio", R.number), a.expr("chamfer", R.object({}, a.atom("top_right"), a.atom("top_left"), a.atom("bottom_right"), a.atom("bottom_left"))), a.pair("pinfunction", R.string), a.pair("pintype", R.string), a.pair("solder_mask_margin", R.number), a.pair("solder_paste_margin", R.number), a.pair("solder_paste_margin_ratio", R.number), a.pair("clearance", R.number), a.pair("thermal_width", R.number), a.pair("thermal_gap", R.number), a.pair("thermal_bridge_angle", R.number), a.pair("zone_connect", R.number), a.pair("tstamp", R.string), a.pair("uuid", R.string), a.pair("remove_unused_layers", R.boolean), a.item("drill", qr), a.item("net", h2), a.item("options", ei), a.expr("primitives", (i, n, o) => V(o, a.start("primitives"), a.collection("items", "gr_line", R.item(Nt, this)), a.collection("items", "gr_circle", R.item(Vt, this)), a.collection("items", "gr_arc", R.item(Pt, this)), a.collection("items", "gr_rect", R.item(Zt, this)), a.collection("items", "gr_poly", R.item(Wt, this)))?.items));
  ...
  , qr = class {
    ...
    static{l(this, "PadDrill")
    }
}
  , ei = class {
    static{l(this, "PadOptions")
    }constructor(e) {
...
var B = {
  ...
  , _e = class {
    constructor(e, t) {
        ...
        this.embedded_fonts = !1;
        this.embedded_files = [];
        Object.assign(this, V(t, a.start("kicad_sch"), a.pair("version", R.number), a.pair("generator", R.string), a.pair("generator_version", R.string), a.pair("uuid", R.string), a.item("paper", bt), a.item("title_block", Qe), a.item("lib_symbols", ai, this), a.collection("wires", "wire", R.item(W2)), a.collection("buses", "bus", R.item(Z2)), a.collection("bus_entries", "bus_entry", R.item(S2)), a.collection("bus_aliases", "bus_alias", R.item(ii)), a.collection("junctions", "junction", R.item(T2)), a.collection("no_connects", "no_connect", R.item(y2)), a.collection("net_labels", "label", R.item(X2)), a.collection("global_labels", "global_label", R.item(O2, this)), a.collection("hierarchical_labels", "hierarchical_label", R.item(ze, this)), a.mapped_collection("symbols", "symbol", r => r.uuid, R.item(re, this)), a.collection("drawings", "polyline", R.item($e, this)), a.collection("drawings", "rectangle", R.item(Xt, this)), a.collection("drawings", "arc", R.item(yt, this)), a.collection("drawings", "text", R.item(Ot, this)), a.collection("drawings", "circle", R.item(Lt, this)), a.collection("rule_areas", "rule_area", R.item(F2, this)), a.collection("netclass_flags", "netclass_flag", R.item(U2, this)), a.collection("images", "image", R.item(ni)), a.item("sheet_instances", pi), a.item("symbol_instances", hi), a.collection("sheets", "sheet", R.item(ne, this)), a.pair("embedded_fonts", R.boolean), a.list("embedded_files", R.item(Ye)))),
        this.update_hierarchical_data()
    }
    static{l(this, "KicadSch")
        ...
        for (let o of this.symbols.values()) {
            let c = `${e}/${o.uuid}`
              , p = t?.get(c) ?? r?.get(c) ?? o.instances.get(e);
        ...
        for (let o of this.sheets) {
            let c = `${e}/${o.uuid}`
              , p = i?.get(c) ?? n?.get(c) ?? o.instances.get(e);
            if (p && (o.page = p.page,
            o.path = p.path,
            !o.instances.size)) {
                let h = new Z3;
  ...
  , ee = class {
    ...
    static{this.common_expr_defs = [a.atom("private"), a.item("stroke", D), a.item("fill", W3), a.pair("uuid", R.string)]
    }
}
  , W2 = class {
    static{l(this, "Wire")
...
`) && (this.text = this.text.slice(0, this.text.length - 1))
  ...
  , O2 = class extends be {
    constructor(t) {
        ...
        this.shape = "input";
        this.properties = [];
        Object.assign(this, V(t, a.start("global_label"), ...be.common_expr_defs, a.pair("shape", R.string), a.collection("properties", "property", R.item(Te))))
    }
    static{l(this, "GlobalLabel")
    }
}
  , ze = class extends be {
    constructor(t) {
    ...
    static{l(this, "HierarchicalLabel")
    }
}
  , U2 = class extends be {
    constructor(t, r) {
        ...
        this.parent = r;
        this.properties = [];
        Object.assign(this, V(t, a.start("netclass_flag"), ...be.common_expr_defs, a.pair("shape", R.string), a.pair("length", R.number), a.collection("properties", "property", R.item(Te, this))))
    }
    static{l(this, "DirectiveLabel")
    }
}
  , ai = class {
    constructor(e, t) {
  ...
  , Ut = class s {
    constructor(e, t) {
        ...
        this.#e = new Map;
        this.#t = new Map;
        Object.assign(this, V(e, a.start("symbol"), a.positional("name"), a.atom("power"), a.object("pin_numbers", this.pin_numbers, a.atom("hide")), a.object("pin_names", this.pin_names, a.pair("offset", R.number), a.atom("hide")), a.pair("in_bom", R.boolean), a.pair("on_board", R.boolean), a.pair("in_pos_files", R.boolean), a.pair("duplicate_pin_numbers_are_jumpers", R.boolean), a.pair("exclude_from_sim", R.boolean), a.mapped_collection("properties", "property", r => r.name, R.item(Te, this)), a.collection("pins", "pin", R.item(li, this)), a.collection("children", "symbol", R.item(s, this)), a.collection("drawings", "arc", R.item(yt, this)), a.collection("drawings", "bezier", R.item(si, this)), a.collection("drawings", "circle", R.item(Lt, this)), a.collection("drawings", "polyline", R.item($e, this)), a.collection("drawings", "rectangle", R.item(Xt, this)), a.collection("drawings", "text", R.item(L2, this)), a.collection("drawings", "textbox", R.item(oi, this)), a.pair("embedded_fonts", R.boolean), a.collection("embedded_files", "file", R.item(Ye))));
  ...
  , Te = class {
    ...
    get effects() {
        return this.#e ? this.#e : (this.parent instanceof re ? this.#e = new G : R2(`Couldn't determine Effects for Property ${this.name}`),
        this.#e)
    }
    set effects(e) {
        this.#e = e
  ...
  , li = class {
    constructor(e, t) {
        ...
        Object.assign(this, V(e, a.start("pin"), a.positional("type", R.string), a.positional("shape", R.string), a.atom("hide"), a.item("at", K), a.pair("length", R.number), a.object("name", this.name, a.positional("text", R.string), a.item("effects", G)), a.object("number", this.number, a.positional("text", R.string), a.item("effects", G)), a.collection("alternates", "alternate", R.item(ci))))
    }
    static{l(this, "PinDefinition")
    }get unit() {
        return this.parent.unit
    }
}
  , ci = class {
    static{l(this, "PinAlternate")
    }constructor(e) {
  ...
  , F2 = class {
    constructor(e, t) {
        this.parent = t;
        Object.assign(this, V(e, a.start("rule_area"), a.item("polyline", $e)))
    }
    static{l(this, "RuleArea")
    }
}
  , re = class {
    constructor(e, t) {
  ...
  , Ri = class {
    static{l(this, "SchematicSymbolInstance")
    }constructor() {}
}
  , x2 = class {
    constructor(e, t) {
  ...
  , pi = class {
    constructor(e) {
        ...
        Object.assign(this, V(e, a.start("sheet_instances"), a.mapped_collection("sheet_instances", "path", t => t.path, R.item(ui))))
    }
    static{l(this, "SheetInstances")
    }get(e) {
        return this.sheet_instances.get(e)
    }
}
  , ui = class {
    static{l(this, "SheetInstance")
    }constructor(e) {
  ...
  , hi = class {
    constructor(e) {
        ...
        Object.assign(this, V(e, a.start("symbol_instances"), a.mapped_collection("symbol_instances", "path", t => t.path, R.item(di))))
    }
    static{l(this, "SymbolInstances")
    }get(e) {
        return this.symbol_instances.get(e)
    }
}
  , di = class {
    static{l(this, "SymbolInstance")
    }constructor(e) {
  ...
  , ne = class {
    constructor(e, t) {
        ...
        this.pins = [];
        this.instances = new Map;
        let r = V(e, a.start("sheet"), a.item("at", K), a.vec2("size"), a.item("stroke", D), a.item("fill", W3), a.pair("fields_autoplaced", R.boolean), a.pair("uuid", R.string), a.mapped_collection("properties", "property", n => n.name, R.item(Te, this)), a.collection("pins", "pin", R.item(mi, this)), a.object("instances", {}, a.collection("projects", "project", R.object(null, a.start("project"), a.positional("name", R.string), a.collection("paths", "path", R.object(null, a.start("path"), a.positional("path"), a.pair("page", R.string)))))))
          , i = r.instances;
        delete r.instances,
        Object.assign(this, r);
        for (let n of i?.projects ?? [])
  ...
  , mi = class {
    ...
    static{l(this, "SchematicSheetPin")
    }
}
  , Z3 = class {
    static{l(this, "SchematicSheetInstance")
    }
}
;
...
var w2 = class s {
    constructor(e) {
        this.setup = new T3;
        this.drawings = [];
        Object.assign(this, V(e, a.start("kicad_wks"), a.pair("version", R.number), a.pair("generator", R.string), a.item("setup", T3), a.collection("drawings", "line", R.item(v2, this)), a.collection("drawings", "rect", R.item(Ft, this)), a.collection("drawings", "polygon", R.item(_i, this)), a.collection("drawings", "bitmap", R.item(bi, this)), a.collection("drawings", "tbtext", R.item(Q2, this))))
    }
    static{l(this, "DrawingSheet")
    }static default() {
        return new s(cn)
    }
    *items() {
  ...
  , oe = class {
    ...
    static{l(this, "DrawingSheetItem")
  ...
  , v2 = class extends oe {
    static{l(this, "Line")
        ...
        super(t),
        Object.assign(this, V(e, a.start("line"), a.item("start", ye), a.item("end", ye), ...oe.common_expr_defs))
    }
}
  , Ft = class extends oe {
    static{l(this, "Rect")
        ...
        super(t),
        Object.assign(this, V(e, a.start("rect"), a.item("start", ye), a.item("end", ye), ...oe.common_expr_defs))
    }
}
  , _i = class extends oe {
    static{l(this, "Polygon")
    }constructor(e, t) {
        super(t),
        Object.assign(this, V(e, a.start("polygon"), a.item("pos", ye), a.pair("rotate", R.number), a.list("pts", R.vec2), ...oe.common_expr_defs))
    }
}
  , bi = class extends oe {
    static{l(this, "Bitmap")
    }constructor(e, t) {
        super(t),
        Object.assign(this, V(e, a.start("bitmap"), a.item("pos", ye), a.pair("scale", R.number), a.pair("pngdata", R.string), ...oe.common_expr_defs))
    }
}
  , Q2 = class extends oe {
    constructor(t, r) {
        ...
        this.incrlabel = 1;
        this.rotate = 0;
        Object.assign(this, V(t, a.start("tbtext"), a.positional("text"), a.item("pos", ye), a.pair("incrlabel", R.number), a.pair("maxlen", R.number), a.pair("maxheight", R.number), a.item("font", fi), a.pair("rotate", R.number), a.pair("justify", R.string), ...oe.common_expr_defs))
    }
    static{l(this, "TbText")
    }get shown_text() {
        return Ke(this.text, this.parent)
    }
}
...
var qe = class s {
    constructor() {
        ...
        this.schematic = new Pi;
        this.sheets = [];
        this.text_variables = {}
    }
    static{l(this, "ProjectSettings")
    }static load(e) {
        let t = new s;
        return Mi(t, e),
        t
  ...
  , gi = class {
    constructor() {
        this.design_settings = new Ni
    }
    static{l(this, "BoardSettings")
    }
}
  , Ni = class {
    constructor() {
        this.defaults = new Vi
    }
    static{l(this, "BoardDesignSettings")
    }
}
  , Vi = class {
    constructor() {
    ...
    static{l(this, "BoardDesignSettingsDefaults")
    }
}
  , Pi = class {
    constructor() {
    ...
    static{l(this, "SchematicSettings")
    }
}
  , Wi = class {
    constructor() {
    ...
    static{l(this, "SchematicDrawingSettings")
    }
}
;
var xt = new te("kicanvas:project")
  , vt = class extends EventTarget {
    constructor() {
        ...
        this.#r = new Map;
        this.loaded = new Pe;
        this.settings = new qe;
        this.#a = null
    }
    static{l(this, "Project")
    }#e;
    #t;
    #r;
    #i;
    ...
    async load(t) {
        ...
        for (; i; ) {
            i = !1;
            let o = Array.from(this.schematics());
            for (let c of o) {
                let p = ct(c.filename);
                for (let h of c.sheets) {
                    if (!h.sheetfile)
                        continue;
                    let m = Be(p, h.sheetfile);
                    o.map(b => b.filename).includes(m) || n.includes(m) || (i = !0,
                    await this.#e.has(m) ? await this.#s(m) : (n.push(m),
                    xt.warn(`file "${m}" is not existed, skip it.`)))
                }
            }
        }
        this.#c(),
    ...
    *schematics() {
    ...
    get has_schematics() {
        return c2(this.schematics()) > 0
    }
    *pages() {
        yield*this.#r.values()
    }
    get first_page() {
        return l2(this.pages())
    }
...
var Y2 = class extends Error {
    ...
    static{l(this, "BaseAPIError")
    }
}
  , Zi = class extends Y2 {
    static{l(this, "UnknownError")
    }constructor(e, t, r) {
        super("UnknownError", e, t, r)
    }
}
  , Si = class extends Y2 {
    static{l(this, "NotFoundError")
    }constructor(e, t) {
        super("NotFoundError", e, "not found", t)
    }
}
  , Ti = class extends Y2 {
    static{l(this, "ForbiddenError")
    }constructor(e, t) {
...
async function y3(s) {
    ...
    case 200:
        return;
    case 403:
        throw new Ti(s.url,s);
    case 404:
        throw new Si(s.url,s);
    case 500:
        throw new Zi(s.url,await s.text(),s)
    }
}
l(y3, "request_error_handler");
var K2 = class s {
    static{l(this, "GitHub")
  ...
  , L3 = class s {
    static{l(this, "GitHubUserContent")
...
var Rn = new L3
  ...
  , X3 = class s extends pt {
    ...
    static{l(this, "GitHubFileSystem")
    }async load_file(t) {
    ...
    async enumerate(t) {
        if (this.single_file)
            return Array.from(this.download_urls.keys()).map(c => ({
                type: "file",
                path: c
            }));
        let r = this.gh_repo.path ?? ""
          ...
          , o = [];
        for (let c of n)
            if (c.type === "file" && s.is_kicad_file(c.name)) {
                let p = t2(r, c.path);
                this.download_urls.set(p, new URL(c.download_url)),
                o.push({
                    type: "file",
                    path: p
                })
    ...
    static async fromURLs(t) {
        let r = K2.parse_url(t);
        if (!r)
            return null;
        r.type == "root" && (r.ref = "HEAD",
        r.type = "tree");
        let i = !1;
        return r.type === "blob" && (["kicad_sch", "kicad_pcb"].includes(Rt(r.path)) ? i = !0 : (r.type = "tree",
        r.path = ct(r.path))),
        new s(t,r,i)
    }
}
...
function pn(s) {
    try {
        ...
        throw new yi("Failed to decode base64 string: " + e)
    }
}
l(pn, "base64_decode");
var Qt = class s {
    static{l(this, "Codeberg")
    ...
    static async request(e, t, r) {
        ...
        if (t) {
            let c = new URLSearchParams(t).toString();
            i.search = `?${c}`
        }
        let n = new Request(i,{
            method: r ? "POST" : "GET",
...
var O3 = class s {
    ...
    static{l(this, "CodebergFileSystem")
    }static{this.kicad_extensions = ["kicad_pcb", "kicad_pro", "kicad_sch"]
    }async setup() {}
    static async fromURLs(e) {
        ...
        if (!r)
            return null;
        let i = `repos/${r.owner}/${r.repo}/contents/${r.path}`
          , n = await Qt.request_json(i);
        Array.isArray(n) || (n = [n]);
        for (let o of n)
            !o.name || !o.git_url || o.type !== "file" || s.kicad_extensions.includes(Rt(o.name)) && t.set(o.name, new URL(o.git_url));
        return t.size == 0 ? null : new s(t)
    }
    *list() {
        yield*this.files_to_urls.keys()
    }
    async get(e) {
        let t = this.files_to_urls.get(e);
        if (!t)
            throw new Error(`File ${e} not found.`);
        let r = await Qt.request_json(t.pathname);
        if (r.encoding !== "base64")
            throw new Error(`Unsupported encoding: ${r.encoding}`);
        let i = pn(r.content);
        return new File([i],e)
    }
    async has(e) {
...
l(un, "parseFlagAttribute");
var H2 = class extends CustomEvent {
    static{l(this, "KiCanvasEvent")
    }constructor(e, t, r=!1) {
        super(e, {
            detail: t,
            composed: !0,
  ...
  , ie = class s extends H2 {
    static{l(this, "KiCanvasLoadEvent")
    }static{this.type = "kicanvas:load"
    }constructor() {
        super(s.type, null)
    }
}
  , z = class s extends H2 {
    static{l(this, "KiCanvasSelectEvent")
    }static{this.type = "kicanvas:select"
    }constructor(e) {
        super(s.type, e, !0)
    }
}
  , Yt = class s extends H2 {
    static{l(this, "KiCanvasMouseMoveEvent")
...
var Ge = class {
    ...
    prep_arc(e, t, r, i, n, o) {
        let c;
        e instanceof fe ? c = e : c = new fe(e,t,r ?? new W(0),i ?? new W(Math.PI * 2),n ?? this.state.stroke_width,o ?? this.state.stroke),
        (!c.color || c.color.is_transparent_black) && (c.color = this.state.stroke ?? u.transparent_black);
        let h = new q(c.center,c.radius,c.start_angle,c.end_angle,c.width).to_polyline();
        return this.line(new x(h,c.width,c.color)),
        c
    }
    prep_line(e, t, r) {
        let i;
...
function et(s, e) {
    ...
    do
        if (r = !1,
        !t.steiner && (x3(t, t.next) || H(t.prev, t, t.next) === 0)) {
            if (k2(t),
            t = e = t.prev,
            t === t.next)
                break;
...
l(et, "filterPoints");
function E2(s, e, t, r, i, n, o) {
    if (s) {
        !o && n && uo(s, r, i, n);
        for (var c = s, p, h; s.prev !== s.next; ) {
            if (p = s.prev,
            h = s.next,
            n ? so(s, r, i, n) : io(s)) {
                e.push(p.i / t | 0),
            ...
            s === c) {
                o ? o === 1 ? (s = no(et(s), e, t),
                E2(s, e, t, r, i, n, 2)) : o === 2 && oo(s, e, t, r, i, n) : E2(et(s), e, t, r, i, n, 1);
                break
            }
        }
    }
...
function io(s) {
    ...
    if (H(e, t, r) >= 0)
        return !1;
    for (var i = e.x, n = t.x, o = r.x, c = e.y, p = t.y, h = r.y, m = i < n ? i < o ? i : o : n < o ? n : o, _ = c < p ? c < h ? c : h : p < h ? p : h, b = i > n ? i > o ? i : o : n > o ? n : o, M = c > p ? c > h ? c : h : p > h ? p : h, g = r.next; g !== e; ) {
        if (g.x >= m && g.x <= b && g.y >= _ && g.y <= M && Kt(i, c, n, p, o, h, g.x, g.y) && H(g.prev, g, g.next) >= 0)
            return !1;
        g = g.next
    }
    return !0
...
function so(s, e, t, r) {
    ...
    if (H(i, n, o) >= 0)
        return !1;
    for (var c = i.x, p = n.x, h = o.x, m = i.y, _ = n.y, b = o.y, M = c < p ? c < h ? c : h : p < h ? p : h, g = m < _ ? m < b ? m : b : _ < b ? _ : b, Z = c > p ? c > h ? c : h : p > h ? p : h, T = m > _ ? m > b ? m : b : _ > b ? _ : b, w = Xi(M, g, e, t, r), C = Xi(Z, T, e, t, r), X = s.prevZ, F = s.nextZ; X && X.z >= w && F && F.z <= C; ) {
        if (X.x >= M && X.x <= Z && X.y >= g && X.y <= T && X !== i && X !== o && Kt(c, m, p, _, h, b, X.x, X.y) && H(X.prev, X, X.next) >= 0 || (X = X.prevZ,
        F.x >= M && F.x <= Z && F.y >= g && F.y <= T && F !== i && F !== o && Kt(c, m, p, _, h, b, F.x, F.y) && H(F.prev, F, F.next) >= 0))
            return !1;
        F = F.nextZ
    }
    for (; X && X.z >= w; ) {
        if (X.x >= M && X.x <= Z && X.y >= g && X.y <= T && X !== i && X !== o && Kt(c, m, p, _, h, b, X.x, X.y) && H(X.prev, X, X.next) >= 0)
            return !1;
        X = X.prevZ
    }
    for (; F && F.z <= C; ) {
        if (F.x >= M && F.x <= Z && F.y >= g && F.y <= T && F !== i && F !== o && Kt(c, m, p, _, h, b, F.x, F.y) && H(F.prev, F, F.next) >= 0)
            return !1;
        F = F.nextZ
    }
    return !0
...
function no(s, e, t) {
    ...
    do {
        var i = r.prev
          , n = r.next.next;
        !x3(i, n) && mn(i, r, r.next, n) && J2(i, n) && J2(n, i) && (e.push(i.i / t | 0),
        e.push(r.i / t | 0),
        e.push(n.i / t | 0),
        k2(r),
        k2(r.next),
...
function Ro(s, e) {
    ...
    do {
        if (i <= t.y && i >= t.next.y && t.next.y !== t.y) {
            var c = t.x + (i - t.y) * (t.next.x - t.x) / (t.next.y - t.y);
            if (c <= r && c > n && (n = c,
    ...
    do
        ...
        J2(t, s) && (b < _ || b === _ && (t.x > o.x || t.x === o.x && po(o, t))) && (o = t,
        _ = b)),
        t = t.next;
    while (t !== p);
    return o
...
l(po, "sectorContainsSector");
function uo(s, e, t, r) {
    var i = s;
    do
        i.z === 0 && (i.z = Xi(i.x, i.y, e, t, r)),
        i.prevZ = i.prev,
        i.nextZ = i.next,
        i = i.next;
    while (i !== s);
...
l(mo, "getLeftmost");
function Kt(s, e, t, r, i, n, o, c) {
    return (i - o) * (e - c) >= (s - o) * (n - c) && (s - o) * (r - c) >= (t - o) * (e - c) && (t - o) * (n - c) >= (i - o) * (r - c)
}
l(Kt, "pointInTriangle");
function _o(s, e) {
    return s.next.i !== e.i && s.prev.i !== e.i && !bo(s, e) && (J2(s, e) && J2(e, s) && fo(s, e) && (H(s.prev, s, e.prev) || H(s, e.prev, e)) || x3(s, e) && H(s.prev, s, s.next) > 0 && H(e.prev, e, e.next) > 0)
}
l(_o, "isValidDiagonal");
function H(s, e, t) {
...
function mn(s, e, t, r) {
    var i = F3(H(s, e, t))
      ...
      , o = F3(H(t, r, s))
      , c = F3(H(t, r, e));
    return !!(i !== n && o !== c || i === 0 && U3(s, t, e) || n === 0 && U3(s, r, e) || o === 0 && U3(t, s, r) || c === 0 && U3(t, e, r))
}
l(mn, "intersects");
function U3(s, e, t) {
...
l(fo, "middleInside");
function _n(s, e) {
    var t = new Oi(s.i,s.x,s.y)
      , r = new Oi(e.i,e.x,e.y)
      , i = s.next
      , n = e.prev;
    return s.next = e,
    e.prev = s,
...
l(Oi, "Node");
I2.deviation = function(s, e, t, r) {
    var i = e && e.length
      , n = i ? e[0] * t : s.length
      , o = Math.abs(Ui(s, 0, n, t));
    if (i)
        for (var c = 0, p = e.length; c < p; c++) {
            var h = e[c] * t
              , m = c < p - 1 ? e[c + 1] * t : s.length;
            o -= Math.abs(Ui(s, h, m, t))
        }
    var _ = 0;
...
var Fi = class {
  ...
  , Ht = class s {
    ...
    #t() {
        ...
        for (let e = 0; e < this.gl.getProgramParameter(this.program, this.gl.ACTIVE_UNIFORMS); e++) {
            ...
            this[t.name] = this.uniforms[t.name] = new Fi(this.gl,t.name,r,t.type)
        }
    }
    #r() {
        this.attribs = {};
  ...
  , Gt = class {
    ...
    buffer(e, t, r, i=!1, n=0, o=0, c) {
        r ??= this.gl.FLOAT;
        let p = new xi(this.gl,c);
        return p.bind(),
...
var tt = class {
    ...
    static tesselate_polyline(e) {
        ...
        for (let _ = 1; _ < r.length; _++) {
            ...
            let Z = this.tesselate_segment(b, M, t)
              , T = t / (g + t);
            c.set(this.quad_to_triangles(Z), m * 2),
  ...
  , w3 = class s {
    ...
    static{l(this, "CircleSet")
    }static async load_shader(e) {
        this.shader = await Ht.load(e, "polyline", vi, wi)
    }
    dispose() {
        this.vao.dispose(),
    ...
    set(e) {
        let {position_array: t, cap_array: r, color_array: i} = tt.tesselate_circles(e);
  ...
  , v3 = class s {
    ...
    set(e) {
        if (!e.length)
            return;
        let t = e.reduce( (h, m) => h + (m.points.length - 1) * tt.vertices_per_quad, 0)
          , r = new Float32Array(t * 2)
          , i = new Float32Array(t)
          , n = new Float32Array(t * 4)
          , o = 0
          ...
          , p = 0;
        for (let h of e) {
            let {position_array: m, cap_array: _, color_array: b} = tt.tesselate_polyline(h);
            r.set(m, o),
            o += m.length,
            i.set(_, c),
            c += _.length,
  ...
  , Q3 = class s {
    ...
    set(e) {
        ...
        for (let p of e) {
            ...
            i.set(p.vertices, o),
            o += p.vertices.length,
            tt.populate_color_data(n, p.color, c, h * 4),
            c += h * 4
        }
  ...
  , A2 = class {
    ...
    static async load_shaders(e) {
        await Promise.all([Q3.load_shader(e), v3.load_shader(e), w3.load_shader(e)])
    }
    dispose() {
        this.#i?.dispose(),
        this.#s?.dispose(),
    ...
    commit() {
        this.#e.length && (this.#i = new Q3(this.gl),
        this.#i.set(this.#e),
        this.#e = void 0),
        this.#r.length && (this.#n = new v3(this.gl),
        this.#n.set(this.#r),
        this.#r = void 0),
        this.#t.length && (this.#s = new w3(this.gl),
        this.#s.set(this.#t),
        this.#t = void 0)
    }
    render(e, t=0, r=1) {
...
;
var Y3 = class extends Ge {
    constructor(t) {
        super(t);
        this.#e = [];
        this.projection_matrix = U.identity()
    }
    static{l(this, "WebGL2Renderer")
    }#e;
    #t;
    async setup() {
    ...
    update_canvas_size() {
        ...
        let t = window.devicePixelRatio
          ...
          , c = Math.round(r.height * t);
        this.canvas_size.x == o && this.canvas_size.y == c || (this.canvas.width = o,
    ...
    start_layer(t, r=0) {
        if (this.gl == null)
            throw new Error("Uninitialized");
        this.#t = new Qi(this,t,new A2(this.gl))
    }
    end_layer() {
        if (this.#t == null)
  ...
  , Qi = class extends Ee {
    ...
    static{l(this, "WebGL2RenderLayer")
    }dispose() {
        this.clear()
    }
    clear() {
...
var Yi = class {
  ...
  , C2 = class s extends Yi {
    constructor(t, r) {
        super();
        this.strokes = t;
        this.bbox = r
    }
    static{l(this, "StrokeGlyph")
    }transform(t, r, i, n, o, c) {
        ...
        for (let m of this.strokes) {
            ...
            for (let b of m) {
                ...
                M = M.add(r),
                o && (M.x = c.x - (M.x - c.x)),
                n.degrees != 0 && (M = n.rotate_point(M, c)),
                _.push(M)
            }
            h.push(_)
        }
...
var Et = class {
    ...
    get_line_extents(e, t, r, i, n) {
        ...
        o.bold = i,
        o.italic = n;
        let {bbox: c} = this.get_markup_as_glyphs(e, new d(0,0), t, new W(0), !1, new d(0,0), o);
    ...
    break_lines(e, t, r, i, n, o) {
        ...
        c.bold = n,
        c.italic = o;
        let p = this.get_text_as_glyphs(" ", r, new d(0,0), new W(0), !1, new d(0,0), c).cursor.x
          , h = e.split(`
`)
          , m = "";
...
`)
    ...
    draw_line(e, t, r, i, n) {
        ...
        let {glyphs: c, bbox: p} = this.get_markup_as_glyphs(t, r, n.size, n.angle, n.mirrored, i, o)
    ...
    get_line_bbox(e, t, r, i) {
        let n = new Je;
        n.italic = i;
        let {bbox: o, next_position: c} = this.get_markup_as_glyphs(e, t, r, new W(0), !1, new d(0,0), n);
        return {
            bbox: o,
            cursor: c
        }
...
`)
    ...
    get_markup_as_glyphs(e, t, r, i, n, o, c) {
        let p = new D2(e);
        return this.get_markup_node_as_glyphs(p.root, t, r, i, n, o, c)
    }
    get_markup_node_as_glyphs(e, t, r, i, n, o, c) {
        let p = []
          , h = []
          , m = t.copy()
          , _ = c.copy();
        if (!e.is_root && (e.subscript && (_ = new Je,
        _.subscript = !0),
        e.superscript && (_ = new Je,
        _.superscript = !0),
        _.overbar ||= e.overbar,
        e.text)) {
    ...
    wordbreak_markup_node(e, t, r) {
        ...
        if (!e.is_root) {
            ...
            o) {
                ...
                let c = e.text.trim().split(" ");
                e.text.endsWith(" ") && c.push(" ");
                for (let p of c) {
...
var Q = class s extends Et {
    ...
    get_glyph(e) {
        let t = G3(e) - G3(" ");
        return t < 0 || t > H3.length ? this.get_glyph("?") : (this.#e.has(t) || this.#i(t),
        this.#e.get(t))
    }
    get_line_extents(e, t, r, i, n) {
    ...
    get_text_as_glyphs(e, t, r, i, n, o, c) {
        let g = []
          , Z = r.copy()
          , T = t.copy()
          , w = c.italic ? s.italic_tilt : 0;
        (c.subscript || c.superscript) && (T = T.multiply(.7),
        c.subscript ? Z.y += T.y * .3 : Z.y -= T.y * .5);
        for (let Fe of e)
            switch (Fe) {
            case "	":
                {
        ...
        let C = !1
          ...
          , F = T.x * .1;
        if (c.overbar ? (C = !0,
        X.y = this.compute_overbar_vertical_position(T.y)) : c.underline && (C = !0,
        X.y = this.compute_underline_vertical_position(T.y)),
        C) {
            c.italic && (X.x = X.y * s.italic_tilt);
            let Fe = new d(r.x + X.x + F,Z.y - X.y)
              , $ = new d(Z.x + X.x - F,Z.y - X.y)
              , se = new C2([[Fe, $]],O.from_points([Fe, $]));
            g.push(se.transform(new d(1,1), new d(0,0), 0, i, n, o))
        }
        let lt = new O;
        return lt.start = r,
        lt.end = new d(Z.x + X.x - Math.round(T.x * .2),Z.y + Math.max(T.y, X.y * s.overbar_position_factor)),
        {
            bbox: lt,
            glyphs: g,
...
`),
        ...
        let p = Q.default()
          ...
          , m = this.bold
          , _ = this.italic
          , b = p.get_line_extents(o, h, c, m, _)
          , M = 0
          , g = b.copy();
        ...
        this.multiline && !e && n.length) {
            for (let T of n.slice(1))
                b = p.get_line_extents(T, h, c, m, _),
...
l(So, "get_bold_thickness");
function To(s) {
    return Math.round(s / 8)
}
l(To, "get_normal_thickness");
function yo(s, e, t) {
    let r = Math.round(e * (t ? .25 : .18));
    return Math.min(s, r)
}
l(yo, "clamp_thickness");
...
;
var B2 = new te("kicanvas:project")
  , Me = class {
    constructor(e, t) {
        this.view_painter = e;
        this.gfx = t
    }
    static{l(this, "ItemPainter")
    }get theme() {
  ...
  , ke = class {
    ...
    paint(e) {
        B2.debug("Painting"),
        B2.debug("Sorting paintable items into layers");
        for (let t of e.items()) {
            let r = this.painter_for(t);
            if (!r) {
                B2.warn(`No painter found for ${t?.constructor.name}`);
                continue
            }
        ...
        for (let t of this.paintable_layers())
            B2.debug(`Painting layer ${t.name} with ${t.items.length} items`),
            this.paint_layer(t);
        B2.debug("Painting complete")
    }
    *paintable_layers() {
  ...
  , it = class s {
    static{l(this, "StrokePainter")
        ...
        for (let[o,c] of s.windowed2_iter(e))
            this.line_helper(o, c, t, r, i)
    }
...
var Ki = class extends Me {
    ...
    paint(t, r) {
        ...
        for (let c = 0; c < r.repeat; c++) {
            let p = new d(n * c,o * c)
              , [h,m] = [j2(i, r.start.position.add(p), r.start.anchor), j2(i, r.end.position.add(p), r.start.anchor)];
            if (!h || !m)
                return;
  ...
  , Hi = class extends Me {
    ...
    paint(t, r) {
        ...
        for (let c = 0; c < r.repeat; c++) {
            let p = new d(n * c,o * c)
              , [h,m] = [j2(i, r.start.position.add(p), r.start.anchor, c > 0), j2(i, r.end.position.add(p), r.end.anchor, c > 0)];
            if (!h || !m)
                return;
  ...
  , Gi = class extends Me {
    ...
    paint(t, r) {
        ...
        for (let c = 0; c < r.repeat; c++) {
            let p = new d(n * c,o * c)
              , h = j2(r.parent, r.pos.position.add(p), r.pos.anchor);
            if (!h)
                return;
  ...
  , k3 = class extends ke {
    static{l(this, "DrawingSheetPainter")
    }constructor(e, t, r) {
        super(e, t, r),
        this.painter_list = [new Ki(this,e), new Hi(this,e), new Gi(this,e)]
    }
    *paintable_layers() {
...
var A3 = class {
    ...
    static{l(this, "GridLOD")
    }
}
  , C3 = class {
    constructor(e, t, r, i=new d(0,0), n=u.white, o=u.white, c=[new A3(2.5,10,.2), new A3(15,1,.05)]) {
        this.gfx = e;
        this.camera = t;
        this.layer = r;
        this.origin = i;
    ...
    update() {
        let e;
        for (let c of this.lods)
            this.camera.zoom >= c.min_zoom && (e = c);
        if (!e) {
            this.reset();
            return
        }
        ...
        for (let c = r; c <= i; c += 1)
            for (let p = n; p <= o; p += 1) {
                let h = new d(c * e.spacing + this.origin.x,p * e.spacing + this.origin.y);
        ...
        if (this.origin.x != 0 && this.origin.y != 0) {
            ...
            let c = new d(1.5,1.5);
            this.gfx.line([this.origin.sub(c), this.origin.add(c)], e.radius / 2, this.origin_color),
            c = new d(-1.5,1.5),
            this.gfx.line([this.origin.sub(c), this.origin.add(c)], e.radius / 2, this.origin_color)
        }
...
var ce = class s extends EventTarget {
    constructor() {
        super(...arguments);
        this.storage = new D3("kc:prefs");
        this.theme = Le.default;
        this.alignControlsWithKiCad = !0
    }
    static{l(this, "Preferences")
        ...
        this.dispatchEvent(new B3({
            preferences: this
        }))
    }
    load() {
        this.theme = Le.by_name(this.storage.get("theme", Le.default.name)),
        this.alignControlsWithKiCad = this.storage.get("alignControlsWithKiCad", !1)
    }
}
;
ce.INSTANCE.load();
var B3 = class s extends CustomEvent {
    static{l(this, "PreferencesChangeEvent")
...
function Sn(s) {
    return class extends s {
        static{l(this, "WithPreferences")
        }constructor(...t) {
            super(...t),
            this.addDisposable(I(ce.INSTANCE, B3.type, () => {
  ...
  , $3 = class {
    constructor(e, t, r, i=.5, n=10, o) {
        ...
        this.target.addEventListener("touchstart", _ => {
            _.touches.length === 2 ? c = this.#t(_.touches) : _.touches.length === 1 && (p = _.touches)
        }
        ),
    ...
    #r(e) {
        ...
        r *= Tn) : e.deltaMode === WheelEvent.DOM_DELTA_PAGE && (t *= j3,
        r *= j3),
        t = Math.sign(t) * Math.min(j3, Math.abs(t)),
        r = Math.sign(r) * Math.min(j3, Math.abs(r)),
...
var q3 = class {
    constructor(e, t) {
        ...
        this.callback = t;
        this.ready = new Pe;
        this.camera = new m3(new d(0,0),new d(0,0),1,new W(0)),
        this.#e = new z3(this.renderer.canvas, () => {
            this.#r(),
            this.callback()
        }
        ),
    ...
    enable_pan_and_zoom(e, t) {
        this.#t = new $3(this.renderer.canvas,this.camera, () => {
            this.callback()
        }
        ,e,t)
    }
...
;
var $2 = class extends EventTarget {
    constructor(t, r=!0) {
        super();
        this.canvas = t;
        this.interactive = r;
    ...
    async setup() {
        ...
        this.viewport = this.disposables.add(new q3(this.renderer, () => {
...
;
P([_t], $2.prototype, "_set_selected", 1);
var Ie = new te("kicanvas:viewer")
  , At = class extends $2 {
    static{l(this, "DocumentViewer")
    }constructor(e, t, r) {
        super(e, t),
        this.theme = r
    }
    ...
    async load(e) {
        ...
        this.document != e && (Ie.info(`Loading ${e.filename} into viewer`),
        this.document = e,
        this.paint(),
        Re(async () => {
            Ie.info("Waiting for viewport"),
            await this.viewport.ready,
            this.viewport.bounds = this.drawing_sheet.page_bbox.grow(50),
            Ie.info("Positioning camera"),
            this.zoom_to_page(),
    ...
    paint() {
        ...
        Ie.info("Loading drawing sheet"),
        this.drawing_sheet || (this.drawing_sheet = w2.default()),
        this.drawing_sheet.document = this.document,
        Ie.info("Creating layers"),
        this.disposables.disposeAndRemove(this.layers),
        this.layers = this.disposables.add(this.create_layer_set()),
        Ie.info("Painting items"),
        this.painter = this.create_painter(),
        this.painter.paint(this.document),
        Ie.info("Painting drawing sheet"),
        new k3(this.renderer,this.layers,this.theme).paint(this.drawing_sheet),
        Ie.info("Painting grid"),
        this.grid = new C3(this.renderer,this.viewport.camera,this.layers.by_name(":Grid"),this.grid_origin,this.theme.grid,this.theme.grid_axes))
    }
    zoom_to_page() {
...
;
var nt = (S => (S.dwgs_user = "Dwgs.User",
...
S))(nt || {})
  ...
  , st = ["F.Cu", "In1.Cu", "In2.Cu", "In3.Cu", "In4.Cu", "In5.Cu", "In6.Cu", "In7.Cu", "In8.Cu", "In9.Cu", "In10.Cu", "In11.Cu", "In12.Cu", "In13.Cu", "In14.Cu", "In15.Cu", "In16.Cu", "In17.Cu", "In18.Cu", "In19.Cu", "In20.Cu", "In21.Cu", "In22.Cu", "In23.Cu", "In24.Cu", "In25.Cu", "In26.Cu", "In27.Cu", "In28.Cu", "In29.Cu", "In30.Cu", "B.Cu"];
function Xe(s, e) {
    return `:${s}:${e}`
}
l(Xe, "virtual_layer_for");
function Xn(s) {
    return s.startsWith(":")
}
l(Xn, "is_virtual");
...
var er = class extends It {
    constructor(t, r) {
        ...
        for (let n of Object.values(nt)) {
            if (!Xn(n) && !i.has(n))
                continue;
            let o = !0
              , c = !1;
            Fo.includes(n) && (o = l( () => this.is_any_copper_layer_visible(), "visible"),
            c = !0),
            (n == ":Pads:Front" || n == ":Pads:Front:NetName") && (o = l( () => this.by_name("F.Cu").visible, "visible"),
            c = !0),
            (n == ":Pads:Back" || n == ":Pads:Back:NetName") && (o = l( () => this.by_name("B.Cu").visible, "visible"),
            c = !0),
            n == ":Pad:Holes:NetName" && (o = l( () => this.by_name(":Pad:Holes").visible, "visible"),
            c = !0),
            On(n) && (c = !0,
            this.add(new ae(this,Xe(n, "BBViaHoles"), () => this.by_name(n).visible,!1,this.color_for(":Via:Holes"))),
            this.add(new ae(this,Xe(n, "BBViaHoleWalls"), () => this.by_name(n).visible,!1,this.color_for(":Via:HoleWalls"))),
            this.add(new ae(this,Xe(n, "Zones"), () => this.by_name(n).visible,!1,this.color_for(n)))),
            this.add(new ae(this,n,o,c,this.color_for(n)))
        }
    }
    static{l(this, "LayerSet")
    }color_for(t) {
        switch (t) {
        case nt.drawing_sheet:
    ...
    *in_ui_order() {
        let t = [...st, "F.Adhes", "B.Adhes", "F.Paste", "B.Paste", "F.SilkS", "B.SilkS", "F.Mask", "B.Mask", "Dwgs.User", "Cmts.User", "Eco1.User", "Eco2.User", "Edge.Cuts", "Margin", "F.CrtYd", "B.CrtYd", "F.Fab", "B.Fab", "User.1", "User.2", "User.3", "User.4", "User.5", "User.6", "User.7", "User.8", "User.9"];
        for (let r of t) {
...
var ge = class extends Me {
    static{l(this, "BoardItemPainter")
    }get theme() {
        return this.view_painter.theme
    }
    get filter_net() {
  ...
  , ot = class extends ge {
    static{l(this, "GraphicItemPainter")
    }styled_line(e, t, r, i) {
        let n = l(o => {
            this.gfx.line(o, t, r)
        }
  ...
  , Ct = class extends ge {
    static{l(this, "NetNameItemPainter")
    }draw_net_name(e, t, r, i, n) {
        let o = new Jt
          , c = t.copy().multiply(1e4)
  ...
  , Ii = class extends ot {
    constructor() {
        super(...arguments);
        this.classes = [Se, Wt, N2]
    }
    static{l(this, "PolyPainter")
    }layers_for(t) {
        return [t.layer]
    }
    paint(t, r) {
  ...
  , Ci = class extends ot {
    ...
    paint(t, r) {
        ...
        if (this.isFillValid(r.fill))
            ...
            let c = o.to_polyline();
            this.gfx.line(new x(c,o.width,i))
        }
    }
}
  , Di = class extends Ct {
    ...
    static{l(this, "TraceSegmentPainter")
    }layers_for(t) {
        return [t.layer]
    }
    paint(t, r) {
  ...
  , ji = class extends Ct {
    ...
    static{l(this, "ViaPainter")
    }layers_for(t) {
        if (t.layers) {
            let r = [];
            for (let i of Fn(t.layers[0], t.layers[1]))
                r.push(Xe(i, "BBViaHoles")),
                r.push(Xe(i, "BBViaHoleWalls"));
            return r
        } else
  ...
  , $i = class extends ge {
    ...
    static{l(this, "ZonePainter")
    }layers_for(t) {
        let r = t.layers ?? [t.layer];
        return r.length && r[0] == "F&B.Cu" && (r.shift(),
        r.push("F.Cu", "B.Cu")),
        r.map(i => st.includes(i) ? Xe(i, "Zones") : i)
    }
    paint(t, r) {
  ...
  , zi = class s extends Ct {
    constructor() {
        super(...arguments);
        this.classes = [P2]
    }
    static{l(this, "PadPainter")
    }layers_for(t) {
        let r = [];
    ...
    paint(t, r) {
        ...
        let o = new d(0,0)
          , c = t.name == ":Pad:Holes" || t.name == ":NonPlatedHoles"
  ...
  , ts = class extends ge {
    ...
    static{l(this, "PropertyTextPainter")
    }layers_for(t) {
        return [t.layer]
    }
    paint(t, r) {
  ...
  , rs = class extends ge {
    ...
    static{l(this, "DimensionPainter")
    }layers_for(t) {
        return [t.layer]
    }
    paint(t, r) {
    ...
    paint_leader(t, r) {
        let i = r.style.thickness ?? .2
          ...
          , p = [c, r.end, r.gr_text.at.position]
        ...
        this.gfx.line([c.add(Z), c, c.add(g)], i, t.color),
        this.paint_text(n)
    }
    paint_linear(t, r) {
        let i = r.style.thickness ?? .2
        ...
        if (r.type == "orthogonal")
            ...
            o = r.start.add(n),
            c = new d(r.end.x,o.y)) : (n = new d(r.height,0),
            o = r.start.add(n),
            c = new d(o.x,r.end.y));
        else {
        ...
        m = h.add(n.resize(p)),
        this.gfx.line([h, m], i, t.color),
        this.gfx.line([o, c], i, t.color);
        let _ = c.sub(o).angle.negative()
        ...
        this.gfx.line([c.sub(g), c, c.sub(M)], i, t.color),
  ...
  , is = class extends ge {
    ...
    static{l(this, "FootprintPainter")
    }layers_for(t) {
        let r = new Set;
  ...
  , tr = class extends ke {
    constructor(t, r, i) {
        ...
        this.painter_list = [new Ji(this,t), new ki(this,t), new Ii(this,t), new Ai(this,t), new Ci(this,t), new Di(this,t), new Bi(this,t), new ji(this,t), new $i(this,t), new zi(this,t), new is(this,t), new qi(this,t), new es(this,t), new ts(this,t), new rs(this,t)]
    }
    static{l(this, "BoardPainter")
    }paint_net(t, r) {
...
var rr = class extends At {
    ...
    create_painter() {
        return new tr(this.renderer,this.layers,this.theme)
    }
    create_layer_set() {
        return new er(this.board,this.theme)
    }
    get grid_origin() {
    ...
    on_pick(e, t) {
        ...
        for (let {bbox: i} of t) {
            let n = i.context;
            n instanceof me ? r.set(`Footprint: ${n.reference}`, n) : Kr(n) ? r.set(`Net: ${n.netname}`, n) : console.log(n)
        }
        if (r.size === 0)
            this.select(null);
    ...
    handleItemClick(e) {
        e instanceof me ? this.select(e) : Kr(e) && this.highlight_net(an(e))
    }
    select(e) {
    ...
    set page_opacity(e) {
        this.layers.by_name(nt.drawing_sheet).opacity = e,
        this.draw()
    }
    zoom_to_board() {
...
;
var Oe = class extends Sn(N) {
    constructor() {
        super(...arguments);
        this.selected = []
    }
    static{l(this, "KCViewerElement")
    }initialContentCallback() {
    ...
    get themeObject() {
        return this.theme ? Le.by_name(this.theme) : ce.INSTANCE.theme
    }
    async load(t) {
        this.loaded = !1,
...
P([L({
    type: Boolean
})], Oe.prototype, "loaded", 2),
P([L({
    type: String
})], Oe.prototype, "theme", 2),
P([L({
    type: Boolean
})], Oe.prototype, "disableinteraction", 2);
var ss = class extends N {
    static{l(this, "KCContextMenuElement")
    }static{this.styles = [...N.styles, y`
            :host {
                position: fixed;
                z-index: 1000;
...
;
window.customElements.define("kc-context-menu", ss);
var z2 = class extends Oe {
    static{l(this, "KCBoardViewerElement")
    }#e = null;
    update_theme() {
        this.viewer.theme = this.themeObject.board
    }
    make_viewer() {
        let e = new rr(this.canvas,!this.disableinteraction,this.themeObject.board);
...
;
window.customElements.define("kc-board-viewer", z2);
var ns = class extends N {
    static{l(this, "KCHelpPanel")
    }static{this.styles = [...N.styles, y`
            p {
                margin: 0;
                padding: 0.5em;
...
;
window.customElements.define("kc-help-panel", ns);
var q2 = ce.INSTANCE
  , ir = class extends N {
    static{l(this, "KCPreferencesPanel")
    }static{this.styles = [...N.styles, y`
            select {
                box-sizing: border-box;
                display: block;
        ...
        this.renderRoot.addEventListener("input", e => {
            let t = e.target;
            t.name === "theme" && (q2.theme = Le.by_name(this.theme_control.value)),
            t.name === "align-controls-kicad" && (q2.alignControlsWithKiCad = t.checked),
            q2.save()
        }
        )
    }
    render() {
        let e = Le.list().map(t => f`<option
                value="${t.name}"
                selected="${q2.theme.name == t.name}">
                ${t.friendly_name}
            </option>`);
        return f`
            <kc-ui-panel>
                    ...
                    <kc-ui-control>
                        <label>
                            <input
                                ...
                                checked="${q2.alignControlsWithKiCad}" />
...
;
P([v("[name=theme]", !0)], ir.prototype, "theme_control", 2);
window.customElements.define("kc-preferences-panel", ir);
var sr = class extends N {
    static{l(this, "KCProjectPanelElement")
    }static{this.styles = [...N.styles, y`
            .page {
                display: flex;
                align-items: center;
...
;
P([_t], sr.prototype, "change_current_project_page", 1);
window.customElements.define("kc-project-panel", sr);
var os = class extends N {
    static{l(this, "KCViewerBottomToolbarElement")
    }static{this.styles = [...N.styles, y`
            output {
                width: unset;
                margin: unset;
...
;
window.customElements.define("kc-viewer-bottom-toolbar", os);
var Ue = class extends N {
    ...
    static{l(this, "KCViewerAppElement")
    }#e;
    #t;
    get viewer() {
    ...
    #r() {
        return c2(this.project.pages()) > 1
    }
    make_pre_activities() {
        let t = [];
    ...
    render() {
        ...
        r.flipview && this.#e instanceof z2 && n.push(f`<kc-ui-button
                    slot="right"
                    name="flip_view"
                    title="flip view"
                    icon="flip"
        ...
        let o = f`<kc-ui-floating-toolbar location="top">
          ...
          , c = null;
        return t != "none" && (c = f`<kc-viewer-bottom-toolbar></kc-viewer-bottom-toolbar>`),
...
P([L({
    type: String
})], Ue.prototype, "controls", 2),
P([L({
    type: String
})], Ue.prototype, "controlslist", 2),
P([L({
    type: Boolean
})], Ue.prototype, "sidebarcollapsed", 2);
var Dt = class extends N {
    static{l(this, "KCBoardFootprintsPanelElement")
    }connectedCallback() {
        (async () => (this.viewer = await this.requestLazyContext("viewer"),
        await this.viewer.loaded,
    ...
    render_list() {
        ...
        for (let r of this.sorted_footprints) {
            ...
            r.layer == "F.Cu" ? e.push(c) : t.push(c)
        }
...
var as = class extends N {
    static{l(this, "KCBoardInfoPanelElement")
    }connectedCallback() {
        (async () => (this.viewer = await this.requestLazyContext("viewer"),
        await this.viewer.loaded,
        super.connectedCallback()))()
    ...
    render() {
        let e = this.viewer.drawing_sheet
          , t = this.viewer.board
          , r = t.edge_cuts_bbox
          , i = l(c => f`<kc-ui-property-list-item
                name="${c}"
                class="label"></kc-ui-property-list-item>`, "header")
          , n = l( (c, p, h="") => f` <kc-ui-property-list-item name="${c}">
                ${p} ${h}
            </kc-ui-property-list-item>`, "entry")
          , o = Object.entries(t.title_block?.comment || {}).map( ([c,p]) => n(`Comment ${c}`, p));
        return f`
            <kc-ui-panel>
...
;
window.customElements.define("kc-board-info-panel", as);
var e3 = class extends N {
    static{l(this, "KCBoardLayersPanelElement")
    }static{this.styles = [...N.styles, y`
            :host {
                display: block;
                height: 100%;
    ...
    initialContentCallback() {
        this.panel_body.addEventListener(t3.select_event, e => {
            let t = e.detail;
        ...
        this.panel_body.addEventListener(t3.visibility_event, e => {
            let t = e.detail
...
;
P([v("kc-ui-panel-body", !0)], e3.prototype, "panel_body", 2),
P([v("#presets", !0)], e3.prototype, "presets_menu", 2);
var Ae = class Ae extends N {
    static{l(this, "KCBoardLayerControlElement")
    }static{this.styles = [...N.styles, y`
            :host {
                box-sizing: border-box;
                padding: 0.1em 0.8em 0.1em 0.4em;
        ...
        this.renderRoot.addEventListener("click", e => {
            ...
            t ? r = Ae.visibility_event : r = Ae.select_event,
...
P([L({
    type: String
})], Ae.prototype, "layer_name", 2),
P([L({
    type: String
})], Ae.prototype, "layer_color", 2),
P([L({
    type: Boolean
})], Ae.prototype, "layer_highlighted", 2),
P([L({
    type: Boolean
})], Ae.prototype, "layer_visible", 2);
var t3 = Ae;
window.customElements.define("kc-board-layer-control", t3);
window.customElements.define("kc-board-layers-panel", e3);
var r3 = class extends N {
    static{l(this, "KCBoardNetsPanelElement")
    }connectedCallback() {
        (async () => (this.viewer = await this.requestLazyContext("viewer"),
        await this.viewer.loaded,
        super.connectedCallback()))()
...
;
P([v("kc-ui-text-filter-input", !0)], r3.prototype, "search_input_elm", 2),
P([v("kc-ui-filtered-list", !0)], r3.prototype, "item_filter_elem", 2);
window.customElements.define("kc-board-nets-panel", r3);
var ls = class extends N {
    static{l(this, "KCBoardObjectsPanelElement")
    }connectedCallback() {
        (async () => (this.viewer = await this.requestLazyContext("viewer"),
        await this.viewer.loaded,
        super.connectedCallback(),
...
;
window.customElements.define("kc-board-objects-panel", ls);
var cs = class extends N {
    static{l(this, "KCBoardPropertiesPanelElement")
    }connectedCallback() {
        (async () => (this.viewer = await this.requestLazyContext("viewer"),
        await this.viewer.loaded,
        super.connectedCallback(),
    ...
    render() {
        let e = l(n => f`<kc-ui-property-list-item class="label" name="${n}">
            </kc-ui-property-list-item>`, "header"), t = l( (n, o, c="") => f`<kc-ui-property-list-item name="${n}">
                ${o ?? ""} ${c}
            </kc-ui-property-list-item>`, "entry"), r = l(n => n ? f`<kc-ui-icon>check</kc-ui-icon>` : f`<kc-ui-icon>close</kc-ui-icon>`, "checkbox"), i;
        if (!this.selected_item)
            i = e("No item selected");
        else {
            let n = this.selected_item
              , o = Object.entries(n.properties).map( ([c,p]) => t(c, p.value));
            i = f`
                ${e("Basic properties")}
...
;
window.customElements.define("kc-board-properties-panel", cs);
var Rs = class extends Ue {
    static{l(this, "KCBoardAppElement")
...
;
window.customElements.define("kc-board-app", Rs);
var nr = class extends Ge {
    ...
    static{l(this, "Canvas2DRenderer")
    }#e;
    #t;
    async setup() {
    ...
    circle(t, r, i) {
        ...
        this.#t.commands.push(new Bt(c,o,null,0))
    }
    line(t, r, i) {
        let n = super.prep_line(t, r, i);
        if (!n.color || n.color.is_transparent_black)
        ...
        for (let h of n.points)
            p ? c.lineTo(h.x, h.y) : (c.moveTo(h.x, h.y),
            p = !0);
        this.#t.commands.push(new Bt(c,null,o,n.width))
    }
    polygon(t, r) {
        let i = super.prep_polygon(t, r);
        ...
        for (let p of i.points)
            c ? o.lineTo(p.x, p.y) : (o.moveTo(p.x, p.y),
            c = !0);
        o.closePath(),
  ...
  , ps = class extends Ee {
    ...
    static{l(this, "Canvas2dRenderLayer")
    }dispose() {
        this.clear()
    }
    clear() {
...
;
var Ce = (M => (M.interactive = ":Interactive",
M.marks = ":Marks",
...
var or = class extends ke {
    static{l(this, "BaseSchematicPainter")
    }
}
  , Y = class extends Me {
    static{l(this, "SchematicItemPainter")
    }get theme() {
        return this.view_painter.theme
    }
    get is_dimmed() {
...
var i3 = class extends Y {
  ...
  , lr = class extends i3 {
    ...
    static{l(this, "GlobalLabelPainter")
    }get color() {
  ...
  , cr = class extends i3 {
    ...
    static{l(this, "HierarchicalLabelPainter")
    }get color() {
    ...
    create_shape(t, r) {
        let i = r.text_pos, n = W.from_degrees(t.at.rotation), o = r.text_width, c;
        switch (t.shape) {
        case "output":
            c = [new d(0,o / 2), new d(o / 2,o / 2), new d(o,0), new d(o / 2,-o / 2), new d(0,-o / 2), new d(0,o / 2)];
            break;
        case "input":
            c = [new d(o,o / 2), new d(o / 2,o / 2), new d(0,0), new d(o / 2,-o / 2), new d(o,-o / 2), new d(o,o / 2)];
            break;
        case "bidirectional":
        case "tri_state":
        ...
        return c = c.map(p => p.rotate(n).add(i).multiply(1 / 1e4)),
        c
    }
}
  , Rr = class extends Y {
    ...
    static{l(this, "DirectiveLabelPainter")
...
;
var pr = class s extends Y {
    constructor() {
        super(...arguments);
        this.classes = [x2]
    }
    static{l(this, "PinPainter")
    }layers_for(t) {
    ...
    draw_name_and_number(t, r) {
        let i = r.def, n = r.pin.parent.lib_symbol, o = r.pin.alternate ?? i.name.text, c = i.number.text, p = i.length, h = n.pin_names.hide || !o || o == "~", m = n.pin_numbers.hide || !c || c == "~", _ = B.line_width, b = n.pin_names.offset, M = .6096 * B.text_offset_ratio, g = i.number.effects.font.thickness || _, Z = i.number.effects.font.thickness || _, T, w;
        ...
        w && $t.draw(t, c, r.position, w, i.number.effects, t.state.stroke)
    }
}
;
function vo(s) {
...
var xn = {
    ...
    draw(s, e, t, r, i, n) {
        ...
        , "clock_notch")
          , m = l( () => {
            n.y ? s.line([i.add(new d(0,n.y).multiply(c)), i.add(new d(-1,n.y).multiply(c)), i]) : s.line([i.add(new d(n.x,0).multiply(c)), i.add(new d(n.x,-1).multiply(c)), i])
        }
        , "low_in_tri");
        switch (t) {
        case "line":
        ...
        case "output_low":
            s.line([i, r]),
            n.y ? s.line([i.sub(new d(c,0)), i.add(new d(0,n.y * c))]) : s.line([i.sub(new d(0,c)), i.add(new d(n.x * c,0))]);
            break;
        case "non_logic":
            s.line([i, r]),
...
var hr = class extends Y {
    ...
    static{l(this, "LibSymbolPainter")
    }layers_for(t) {
  ...
  , dr = class extends Y {
    ...
    static{l(this, "SchematicSymbolPainter")
    }layers_for(t) {
    ...
    paint(t, r) {
        ...
        if (t.name == ":Symbol:Field" || t.name == ":Interactive")
            for (let[o,c] of r.properties)
                this.view_painter.paint_item(t, c);
        if (r.dnp && t.name == ":Marks") {
            let o = Yo(this.theme, r)
              , c = B.line_width * 3
              , p = this.theme.erc_error;
            this.gfx.line([o.top_left, o.bottom_right], c, p),
            this.gfx.line([o.bottom_left, o.top_right], c, p)
        }
...
l(Yo, "get_symbol_body_and_pins_bbox");
var hs = class extends Y {
    constructor() {
        super(...arguments);
        this.classes = [Xt]
    }
    static{l(this, "RectanglePainter")
    }layers_for(t) {
        return [":Notes"]
    }
    paint(t, r) {
  ...
  , ds = class extends Y {
    ...
    #e(t, r) {
        ...
        , "draw_line");
        it.line(r.pts, i, r.stroke_params, o)
    }
    #t(t, r) {
  ...
  , ms = class extends Y {
    ...
    paint(t, r) {
        ...
        let o = r.polyline.stroke?.width || this.gfx.state.stroke_width
          , c = r.polyline.stroke?.color || this.theme.rule_area;
        if (o && c) {
            let p = l(h => {
                this.gfx.line(h, o, c)
            }
            , "draw_line");
            it.line(i, o, r.polyline.stroke_params, p)
        }
    }
}
  , _s = class extends Y {
  ...
  , Vs = class extends Y {
    ...
    static{l(this, "NoConnectPainter")
    }layers_for(t) {
        return [":Junction"]
    }
    paint(t, r) {
  ...
  , Ss = class extends Y {
    ...
    static{l(this, "SchematicSheetPainter")
    }layers_for(t) {
    ...
    paint(t, r) {
        ...
        t.name == ":Symbol:Field")
            for (let c of r.properties.values())
                this.view_painter.paint_item(t, c);
        if (t.name == ":Label")
            for (let c of r.pins) {
                let p = new ze;
                switch (p.at = c.at.copy(),
                p.effects = c.effects,
                p.text = c.name,
                p.shape = c.shape,
                p.at.rotation) {
                ...
                c.shape == "input" ? p.shape = "output" : c.shape == "output" && (p.shape = "input"),
                this.view_painter.paint_item(t, p)
            }
    }
}
  , zt = class extends or {
    static{l(this, "SchematicPainter")
    }constructor(e, t, r) {
        super(e, t, r),
        this.painter_list = [new hs(this,e), new ds(this,e), new ms(this,e), new _s(this,e), new bs(this,e), new fs(this,e), new Ms(this,e), new gs(this,e), new Ns(this,e), new Vs(this,e), new Ps(this,e), new Zs(this,e), new pr(this,e), new hr(this,e), new Ws(this,e), new dr(this,e), new ar(this,e), new Rr(this,e), new lr(this,e), new cr(this,e), new Ss(this,e)]
    }
}
;
var mr = class extends At {
    static{l(this, "SchematicViewer")
    }get schematic() {
        return this.document
    }
    create_renderer(e) {
...
var Ts = class extends Oe {
    static{l(this, "KCSchematicViewerElement")
    }update_theme() {
        this.viewer.theme = this.themeObject.schematic
    }
    make_viewer() {
        return new mr(this.canvas,!this.disableinteraction,this.themeObject.schematic)
    }
}
;
window.customElements.define("kc-schematic-viewer", Ts);
var ys = class extends N {
    static{l(this, "KCSchematicInfoPanel")
    }connectedCallback() {
        (async () => (this.viewer = await this.requestLazyContext("viewer"),
        await this.viewer.loaded,
        super.connectedCallback(),
    ...
    render() {
        let e = this.viewer.drawing_sheet
          ...
          , r = l(o => f`<kc-ui-property-list-item
                class="label"
                name="${o}"></kc-ui-property-list-item>`, "header")
          , i = l( (o, c, p="") => f`<kc-ui-property-list-item name="${o}">
                ${c} ${p}
            </kc-ui-property-list-item>`, "entry")
          , n = Object.entries(t.title_block?.comment || {}).map( ([o,c]) => i(`Comment ${o}`, c));
        return f`
            <kc-ui-panel>
                <kc-ui-panel-title title="Info"></kc-ui-panel-title>
                <kc-ui-panel-body>
...
;
window.customElements.define("kc-schematic-info-panel", ys);
var Ls = class extends N {
    static{l(this, "KCSchematicPropertiesPanelElement")
    }connectedCallback() {
        (async () => (this.viewer = await this.requestLazyContext("viewer"),
        await this.viewer.loaded,
        super.connectedCallback(),
    ...
    render() {
        let e = l(o => f`<kc-ui-property-list-item
                class="label"
                name="${o}"></kc-ui-property-list-item>`, "header"), t = l( (o, c, p="") => f`<kc-ui-property-list-item name="${o}">
                ${c ?? ""} ${p}
            </kc-ui-property-list-item>`, "entry"), r = l(o => o ? f`<kc-ui-icon>check</kc-ui-icon>` : f`<kc-ui-icon>close</kc-ui-icon>`, "checkbox"), i, n = this.selected_item;
        if (!n)
            i = e("No item selected");
        else if (n instanceof re) {
            let o = n.lib_symbol
              , c = Array.from(n.properties.values()).map(h => t(h.name, h.text))
            ...
            let o = Array.from(n.properties.values()).map(p => t(p.name, p.text))
              , c = pe(n.pins, p => p.name).map(p => t(p.name, p.shape));
            i = f`
                ${e("Basic properties")}
                ${t("X", n.at.position.x.toFixed(4), "mm")}
                ${t("Y", n.at.position.y.toFixed(4), "mm")}
...
;
window.customElements.define("kc-schematic-properties-panel", Ls);
var qt = class extends N {
    static{l(this, "KCSchematicSymbolsPanelElement")
    }connectedCallback() {
        (async () => (this.viewer = await this.requestLazyContext("viewer"),
        await this.viewer.loaded,
        super.connectedCallback(),
    ...
    render() {
        let e = this.viewer.schematic
          ...
          , r = []
          , i = []
          , n = pe(Array.from(e.symbols.values()), c => c.reference);
        for (let c of n) {
            let p = `${c.reference} ${c.value} ${c.id} ${c.lib_symbol.name}`
              , h = f`<kc-ui-menu-item
                name="${c.uuid}"
                data-match-text="${p}">
            ...
            c.lib_symbol.power ? r.push(h) : t.push(h)
        }
        let o = pe(e.sheets, c => c.sheetname ?? c.sheetfile ?? "");
        for (let c of o) {
            let p = `${c.sheetname} ${c.sheetfile}`;
...
var Xs = class extends Ue {
    static{l(this, "KCSchematicAppElement")
    }on_viewer_select(e, t) {
        if (!(!e || e != t)) {
            if (e instanceof ne) {
...
var De = class extends N {
    ...
    static{l(this, "KiCanvasShellElement")
    }static{this.styles = [...N.styles, new We(_r), new We(wn)]
    }#e;
    #t;
    initialContentCallback() {
        ...
        this.link_input.addEventListener("input", async n => {
            let o = this.link_input.value
              , c = await this.load_repo(o);
            if (!c) {
                console.error(`Invalid URL: ${o}`);
                return
            }
            await this.setup_project(c);
    ...
    async load_repo(t) {
        return await X3.fromURLs(t) ?? await O3.fromURLs(t)
    }
...
P([L({
    type: Boolean
})], De.prototype, "loaded", 2),
P([L({
    type: String
})], De.prototype, "src", 2),
P([v('input[name="link"]', !0)], De.prototype, "link_input", 2),
P([v('button[name="open_local"]', !0)], De.prototype, "open_file_button", 2);
window.customElements.define("kc-kicanvas-shell", De);
var s3 = new te("kicanvas:embedtag")
  , Ne = class extends N {
    constructor() {
        super();
        this.#e = new vt;
    ...
    static{l(this, "KiCanvasEmbedElement")
    }static{this.styles = [...N.styles, new We(_r), y`
            :host {
                margin: 0;
                display: flex;
                position: relative;
    ...
    async #s() {
        ...
        for (let p of this.querySelectorAll("kicanvas-source"))
            if (p.src)
                ...
                m && (s3.info(`Determined inline source ${m.name}, ${m.size} bytes`),
                r.push(m))
            }
        let n = t.length === 0 ? null : new ut(t,this.custom_resolver)
          , o = r.length === 0 ? null : new ht(r);
        if (n === null && o === null) {
            s3.warn("No valid sources specified");
            return
        }
        let c = new o3([n, o]);
        await this.#n(c)
...
var at = class at extends we {
    static{l(this, "KiCanvasSourceElement")
    }constructor() {
        super()
    }
    connectedCallback() {
    ...
    load_inline_source(e=null) {
        ...
        for (let o of this.childNodes)
            o.nodeType === Node.TEXT_NODE ? t += o.nodeValue ?? "" : s3.warn(`kicanvas-source children ${o.nodeType} are invaild.`);
        t = t.trimStart();
        let r;
        if (this.name)
            r = this.name;
        else {
            let o = this.type ?? at.determine_file_type(t);
            if (o === void 0) {
                s3.warn(`Unknown file type, content: ${t.slice(0, 64)}...`);
                return
            }
            let c = at.get_file_ext(o);
            r = (e ?? "noname") + c
        }
        if (t.length === 0) {
            s3.warn(`kicanvas-source content ${r} is empty.`);
            return
        }
        let i = new Blob([t],{
            type: "text/plain"
...
var Os = at;
window.customElements.define("kicanvas-source", Os);
